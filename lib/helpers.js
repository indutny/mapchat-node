...
exports.require = function(filepath, context) {
  ...
  fn(require, dirname, filepath, module, exports);
  
  return module.exports;
}

/**
* Save value into object, using route as key
*
* Example:
* var obj = {};
* routeSave(obj, 'nested.path', 1);
* obj; // {nested:{path: 1}}
*/
exports.routeSave = function(object, route, value) {
  route = route.split('.');
